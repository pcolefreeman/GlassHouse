"""
glasshouseV1.py  —  Project Glass House  |  Combined CSI Writer + Processor | Based on GH_NaNFix.py
==========================================================================
...
# ============================================================
BIN_DIR         = r"C:\Users\19124\OneDrive\Documents\Senior_Cap\GitRepo\GlassHouse\GHV1\CSI_data" # *** replace on new computer
BASE_OUTPUT_DIR = r"C:\Users\19124\OneDrive\Documents\Senior_Cap\GitRepo\GlassHouse\GHV1\data\raw" # *** replace on new computer
...
# Derived from SHOUTER_MACS — only active shouters get columns in the CSV.
ACTIVE_SHOUTER_IDS = None  # set after SHOUTER_MACS is defined below
...
def bucket_frames(frames):
    ...
    for frame in frames:
        ...
        buckets.setdefault(bid, {s: [] for s in ACTIVE_SHOUTER_IDS})
