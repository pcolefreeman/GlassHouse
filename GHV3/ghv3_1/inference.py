"""inference.py — GHV3 live inference with spacing features.
...
from ghv3_1.config import PAIR_KEYS, BAUD_RATE
...
def main():
    parser = argparse.ArgumentParser(description="GHV3 live inference")
