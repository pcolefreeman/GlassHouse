"""app.py — GHV3.1 application shell and tab router."""
...
from ghv3_1.ui.capture_tab import CaptureTab
from ghv3_1.ui.debug_tab import ListenerDebugTab, ShouterDebugTab


def _install_crash_logger() -> None:
    """Write unhandled exceptions to ghv3_crash.log."""
    if getattr(sys, "frozen", False):
        log_dir = os.path.dirname(sys.executable)
    else:
        log_dir = os.path.dirname(os.path.abspath(__file__))
    log_path = os.path.join(log_dir, "ghv3_crash.log")
