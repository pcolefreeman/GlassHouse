...
def _run_multiple_windows(det, n_calls=8):
    ...
    """
    import ghv5.breathing as breathing_mod
...
class TestBreathingDetectorE2E:
    ...
    def test_breathing_analyzer_detects_025hz(self):
        ...
        from ghv5.config import BREATHING_WINDOW_N, BREATHING_SNAP_HZ
        from ghv5.breathing import BreathingAnalyzer, CSIRatioExtractor
    ...
    def test_presence_scorer_coherent_beats_noise(self):
        ...
        from ghv5.config import BREATHING_WINDOW_N, BREATHING_SNAP_HZ, SUBCARRIERS
        from ghv5.breathing import PresenceScorer, CSIRingBuffer
...
class TestFewPathsFallback:
    ...
    def test_two_paths_uses_phase_only(self):
        ...
        from ghv5.config import BREATHING_WINDOW_N, BREATHING_SNAP_HZ, BREATHING_PATH_MAP
        det = BreathingDetector()
        n_time = BREATHING_WINDOW_N
        n_sub = 128
        t = np.arange(n_time) / BREATHING_SNAP_HZ
