"""Tests for ghv5.signal_hardening — CSI signal conditioning transforms.
...
pytestmark = pytest.mark.skip(
    reason="ghv5.signal_hardening module does not exist yet"
)
...
class TestSignalHardeningPlaceholder:
    def test_module_importable(self):
        ...
        from ghv5 import signal_hardening  # noqa: F401
