# tests/test_ghv2_ui_logic.py
"""Tests for ghv2_ui_logic — pure helpers with no UI dependency."""
import pytest
from ghv2_ui_logic import (
...
def test_first_cell_empty_returns_origin():
    assert first_cell(set()) == (0, 0)
